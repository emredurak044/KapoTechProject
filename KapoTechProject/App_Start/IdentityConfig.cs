...
//[assembly: OwinStartup(typeof(KapoTechProject.App_Start.IdentityConfig))]
...
namespace KapoTechProject
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<KapoTechContext>()));
